(function($) {
  ...
  $('#element').typed({
    strings: ["Analista de TI", "Técnico de NOC", "Analista de Suporte", "Outsourcing"],
    typeSpeed: -50,
    loop: true,
    startDelay: 500,
    backDelay: 3000,
  ...
  var mymap = L.map('map').setView([-23.518, -46.898], 14);

  L.tileLayer('https://api.mapbox.com/styles/v1/{id}/tiles/{z}/{x}/{y}?access_token=pk.eyJ1IjoibWhpZ2FraSIsImEiOiJja2ZnM2dmengwM3lkMnBxOWdpeDQxMzU1In0.1unI37R2e0LrbMZ8neXHgw', {
    maxZoom: 18,
    attribution: '',
